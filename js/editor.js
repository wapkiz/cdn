...
(function (factory) {
  ...
  var Context = function ($note, options) {
    ...
    this._initialize = function () {
      ...
      var modules = $.extend({}, this.options.modules, $.samedit.plugins || {});
    ...
    this.triggerEvent = function () {
      ...
      $note.trigger('samedit.' + namespace, args);
    };
  ...
  $.fn.extend({
    ...
    samedit: function () {
      ...
      options = $.extend({}, $.samedit.options, options);

      // Update options
      options.langInfo = $.extend(true, {}, $.samedit.lang['en-US'], $.samedit.lang[options.lang]);
      options.icons = $.extend(true, {}, $.samedit.options.icons, options.icons);
      options.tooltip = options.tooltip === 'auto' ? !agent.isSupportTouch : options.tooltip;

      this.each(function (idx, note) {
        var $note = $(note);
        if (!$note.data('samedit')) {
          var context = new Context($note, options);
          $note.data('samedit', context);
          $note.data('samedit').triggerEvent('init', context.layoutInfo);
        }
      });

      var $note = this.first();
      if ($note.length) {
        var context = $note.data('samedit');
  ...
  */
  ...
  var Handle = function (context) {
    ...
    this.events = {
      'samedit.mousedown': function (we, e) {
        if (self.update(e.target)) {
          e.preventDefault();
        }
      },
      'samedit.keyup samedit.scroll samedit.change samedit.dialog.shown': function () {
        self.update();
      },
      'samedit.disable': function () {
        self.hide();
      },
      'samedit.codeview.toggled': function () {
        self.update();
      }
    };
  ...
  var Placeholder = function (context) {
    ...
    this.events = {
      'samedit.init samedit.change': function () {
        self.update();
      },
      'samedit.codeview.toggled': function () {
        self.update();
  ...
  var Toolbar = function (context) {
    ...
    this.initialize = function () {
      ...
      $note.on('samedit.keyup samedit.mouseup samedit.change', function () {
  ...
  var LinkPopover = function (context) {
    ...
    this.events = {
      'samedit.keyup samedit.mouseup samedit.change samedit.scroll': function () {
        self.update();
      },
      'samedit.disable samedit.dialog.shown': function () {
        self.hide();
      }
    };
  ...
  var TablePopover = function (context) {
    ...
    this.events = {
      ...
      'samedit.keyup samedit.scroll samedit.change': function () {
        self.update();
      },
      'samedit.disable': function () {
        self.hide();
  ...
  var HelpDialog = function (context) {
    ...
    this.initialize = function () {
      ...
      var body = [
        '<p class="text-center">',
        '<a href="http://wapkiz.com/" target="_blank">Wapkiz.com</a> · ',
        '</p>'
      ].join('');
  ...
  var AirPopover = function (context) {
    ...
    this.events = {
      'samedit.keyup samedit.mouseup samedit.scroll': function () {
        self.update();
      },
      'samedit.disable samedit.change samedit.dialog.shown': function () {
        self.hide();
      },
      'samedit.focusout': function (we, e) {
